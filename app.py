...
OFFER_PARAMS = {
    "coin": {"name": "🪙 Coin (Mejor/Best)", "params": {"sourceType": "620%26channel=coin" , "afSmartRedirect": "y"}},
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_html(
        ...
        "🇪🇸 IDIOMA ESPAÑOL 🇲🇽\n\n"
        "👋 ¡Bienvenido al Bot de Descuentos de AliExpress! 👋\n\n"
        "<b>Cómo usar este bot:</b>\n"
        "1️⃣ Copia el enlace de un producto de AliExpress 📋\n"
        "2️⃣ Envía el enlace a este bot 🤖\n"
        "3️⃣ El bot generará automáticamente enlaces de afiliado para ti ✨\n"
        "4️⃣ Usa los enlaces para compartir y ganar 💰\n\n"
        "<b>Tipos de enlaces soportados:</b>\n"
        "• Enlaces de productos regulares de AliExpress 🌐\n"
        "• Enlaces acortados de AliExpress 🔗\n\n"
        "🚀 ¡Envía cualquier enlace de producto de AliExpress ahora para probar el bot! 🎁"
    )
...
async def process_product_telegram(product_id: str, base_url: str, update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Add footer text
        message_lines.append("\n<i>OfertonesAliexpress</i>")
        response_text = "\n".join(message_lines)

        # --- Create Inline Keyboard ---
        keyboard = [
            [
                InlineKeyboardButton("Choice Day", url="https://s.click.aliexpress.com/e/_c3K77zOT"),
